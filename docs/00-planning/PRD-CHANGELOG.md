...
| P8 | Webster parameterisation — **partially advanced** | Before M3 (W10) | [ADR-011](decisions/ADR-011-webster-definition.md) settles cycle clamping, split allocation, and the one-implementation-two-configs question. **Saturation flow and lost time remain open** — [RESEARCH-001](research/RESEARCH-001-webster-parameterisation.md) returned no external evidence. FR-R08's headline claim still depends on this |
